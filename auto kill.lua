    ...
    while true do
        if lp.Character and lp.Character:FindFirstChild("Punch") then
            ...
            for _, trk in pairs(lp.Character.Humanoid.Animator:GetPlayingAnimationTracks()) do
                ...
                if id and (id:find("3638729053") or id:find("3638749874") or id:find("3638767427") or id:find("102357151005774")) then
                    trk:Stop()
                end
            end
        ...
        game:GetService("TweenService"):Create(game.Workspace, TweenInfo.new(0), {}):Play()
    end
end)
